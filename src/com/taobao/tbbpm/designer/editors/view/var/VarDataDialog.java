 ...
 * 
 */
public class VarDataDialog extends EditBasicDialog<Map<String, String>>
	...
	public VarDataDialog(Shell parentShell) {
	...
	public Control createDialogArea(Composite parent) {
		...
		this.table.addSelectionListener(new SelectionListener() {
			...
			public void widgetDefaultSelected(SelectionEvent e) {
				VarDataDialog.this.removeButton
						.setEnabled(VarDataDialog.this.table
								.getSelectionIndex() != -1);
			}
		...
		addButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent event) {
				VarDataDialog.this.addButtonPressed();
			}
		});
		gd = new GridData();
		gd.horizontalAlignment = 4;
		...
		this.removeButton.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent event) {
				VarDataDialog.this.removeButtonPressed();
			}
		});
		gd = new GridData();
